...
module.exports = function processRequest(options, request, response) {
    ...
    const responseHeaders = {
        // set default headers if they are provided.
        // it's necessary since ILC sets to response "setHeader('Set-Cookie', 'ilc-i18n')".
        // So since "setHeader" values are overridden with "writeHead" value, then as result we can lose "ilc-i18n" in case of setting 'Set-Cookie' header by some fragment.
        ...response.getHeaders(),
